		...
		if (readingMolecularIons && !foundDerivation && !foundPutative) {
			JOptionPane.showMessageDialog(null,
					"PostProcess cannot calculate a neutral mass because your Binner report does not have a \"Derivations\" or a \"Derived Molecular Mass\""
							...
							+ PostProccessConstants.DERIVATION_CHOICES_ARRAY + PostProccessConstants.LINE_SEPARATOR
							+ PostProccessConstants.LINE_SEPARATOR
							...
							+ PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR + "     "
							+ PostProccessConstants.PUTATIVEMASS_CHOICES_ARRAY + PostProccessConstants.LINE_SEPARATOR
							+ PostProccessConstants.LINE_SEPARATOR
		...
		if (!foundFeature) {
			...
			JOptionPane.showMessageDialog(null,
					"PostProcess is unable to locate the feature name column in your Binner Report.  "
							...
							+ PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR
							+ PostProccessConstants.COMPOUND_CHOICES_ARRAY + PostProccessConstants.LINE_SEPARATOR
							+ PostProccessConstants.LINE_SEPARATOR
		...
		if (!foundMass) {
			...
			JOptionPane.showMessageDialog(null,
					"PostProcess is unable to locate the mass column in your Binner Report.  "
							...
							+ PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR
							+ PostProccessConstants.MASS_CHOICES_ARRAY + PostProccessConstants.LINE_SEPARATOR
							+ PostProccessConstants.LINE_SEPARATOR
		...
		if (!foundRT) {
			...
			JOptionPane.showMessageDialog(null,
					"PostProcess is unable to locate the retention time column in your Binner Report.  "
							...
							+ PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR
							+ PostProccessConstants.RT_CHOICES_ARRAY + PostProccessConstants.LINE_SEPARATOR
							+ PostProccessConstants.LINE_SEPARATOR
