...
import edu.umich.batchmatch.utils.MyDataFormatter;

public class MetabolomicsManifestDataReader {
	...
	protected Boolean foundMrc2SampleId, foundSampleId, foundRawFile, foundInjectionTime;
	protected Boolean foundSamplePosition, foundSampleName, foundSampleType, foundOtherSampleType;
	protected Boolean foundSampleOrder, foundTime, foundBatchNo;

	/*
	 * private String mrc2SampleId = "", sampleId = "", rawFile = "", injectionTime
	 * = ""; private String samplePosition = "", sampleName = "", sampleType = "",
	 * otherSampleType = ""; private String sampleOrder = "", time = "", batchNo =
	 * "";
	 * 
	 */
	...
	public MetabolomicsManifestDataReader(String filename) {
	...
	protected void initializeHeaderTagMap() {
		 ...
		 * 
		 * for (String hdr : BatchMatchw!@
		 * 
		 * R4 onstants.BATCH_IDX_CHOICES_ARRAY) headerTagMap.put(hdr, "batch");
		 * 
	 ...
	 * 
	 * //String pasteValue = null; returnValue = null;
	 * 
	 * //cellExtension.setCell(cell);
	 * 
	 * switch (cell.getCellType()) { case Cell.CELL_TYPE_BOOLEAN: returnValue = "" +
	 * cell.getBooleanCellValue(); break;
	 * 
	 * case Cell.CELL_TYPE_STRING: //bug? default: pasteValue =
	 * cell.getStringCellValue(); pasteValue = pasteValue.replace("\"", "");
	 * pasteValue = pasteValue.replace("=", ""); returnValue = pasteValue; break;
	 * case Cell.CELL_TYPE_BLANK: returnValue = ""; break;
	 * 
	 * case Cell.CELL_TYPE_NUMERIC: //if (DateUtil.isCellDateFormatted(cell)) { if
	 * (DateUtil.isCellDateFormatted(cell)) { //SimpleDateFormat fmt = new
	 * SimpleDateFormat("M/d/yyyy"); returnValue =
	 * dateFmt.format(cell.getDateCellValue()); } else { formatter = new
	 * MyDataFormatter(); //String formattedValue = returnValue =
	 * formatter.formatCellValue(cell); } break;
	 * 
	 * } return returnValue; }
	 * 
	 ...
	 * + PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR
	 * + "     " + PostProccessConstants.DERIVATION_CHOICES_ARRAY +
	 * PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR +
	 ...
	 * + PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR
	 * + "     " + PostProccessConstants.PUTATIVEMASS_CHOICES_ARRAY +
	 * PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR +
	 ...
	 * + PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR
	 * + PostProccessConstants.COMPOUND_CHOICES_ARRAY +
	 * PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR +
	 * "Please update the headers in your report file to clearly indicate which column contains "
	 * + PostProccessConstants.LINE_SEPARATOR +
	 * "names of the features you'd like to put through a library search."); return
	 * false; }
	 * 
	 * if (!foundMass) {
	 * 
	 ...
	 * + PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR
	 * + PostProccessConstants.MASS_CHOICES_ARRAY +
	 * PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR +
	 * "Please update the headers in your report file to clearly indicate which column contains the feature "
	 * + PostProccessConstants.LINE_SEPARATOR +
	 * "mass of the features you'd like to put through a library search."); return
	 * false; }
	 * 
	 * if (!foundRT) {
	 * 
	 ...
	 * + PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR
	 * + PostProccessConstants.RT_CHOICES_ARRAY +
	 * PostProccessConstants.LINE_SEPARATOR + PostProccessConstants.LINE_SEPARATOR +
	 * "Please update the headers in your report file to clearly indicate which column contains retention "
	 * + PostProccessConstants.LINE_SEPARATOR +
	 * "times of the features you'd like to put through a library search."); return
	 * false; } return true; }
	 * 
	 * 
	 ...
	 * return false;
	 * 
	 * //Cell c = r.getCell(col, Row.CREATE_NULL_AS_BLANK); /* if (r.getCell(col,
	 * Row.CREATE_NULL_AS_BLANK) != null && r.getCell(col,
	...
	// }
	/*
	 * protected String pullValue(Row r, int col) { //Cell c = r.getCell(col,
	 * Row.CREATE_NULL_AS_BLANK); try { return handleCell(r.getCell(col,
	 * Row.CREATE_NULL_AS_BLANK)); } catch (Exception e) {
	 * System.out.println("Null cell"); } return null; }
	 * 
	 * protected void initializeMissingValueInfo(FeatureFromFile feature) { //"Batch
	 * Collection<String> rawIntensities =
	 * feature.getIntensityValuesByHeaderMap().values();
	 * 
	 * int arraySize = rawIntensities.size(); if
	 * (feature.getIntensityValuesByHeaderMap().containsKey("-") ||
	 * feature.getIntensityValuesByHeaderMap().containsKey("")) arraySize--;
	 * 
	 * int nMissing = 0; for (String value : rawIntensities) { try {
	 * Double.parseDouble(value); } catch (Exception e) { nMissing++; } }
	 * 
	 * if (feature.getIntensityValuesByHeaderMap().containsKey("-") ||
	 * feature.getIntensityValuesByHeaderMap().containsKey("")); nMissing--;
	 * 
	 * feature.setnMissingIntensityValues(nMissing);
	 * feature.setnTotalIntensityValues(arraySize); feature.setPctMissing(100.0 *
	 * (nMissing * 1.0)/(arraySize* 1.0)); }
	 */
