...
////////////////////////////////////////////////////
package edu.umich.batchmatch.utils.massdiff;
...
import edu.umich.batchmatch.data.AnnotationInfo;
import edu.umich.batchmatch.main.BinnerConstants2;
import edu.umich.batchmatch.utils.BinnerTestUtils;


//import edu.umich.wiggie.util.BinnerConstants;

public class MassDiffHistogram {
	private double multiplier = 1000.0, upperThreshold = BinnerConstants2.LARGEST_MASS_DIFF, trackingCutoff;
	...
	public void generateHistogram(Map<Integer, AnnotationInfo> annotFileMap, Double minValue, Double maxValue) {
		...
		nTotalPoints = 0;
		int denseCutoffIdx = Math.min(((int) (BinnerConstants2.DENSE_MASS_DIFF_THRESHOLD * multiplier)),
				countsBySlot.length);
