...
import edu.umich.batchmatch.gui.panels.BatchMatchCSVReportLoaderPanel;
import edu.umich.batchmatch.gui.panels.BatchMatchSummaryReportTypePanel;
import edu.umich.batchmatch.gui.panels.FeatureListLoaderPanel;
import edu.umich.batchmatch.gui.panels.FileLayoutPanel;
import edu.umich.batchmatch.gui.panels.IntegerPickerPanel;
import edu.umich.batchmatch.gui.panels.IntegerRangePickerPanel;
import edu.umich.batchmatch.gui.panels.OutputFileNameTagPanel;
import edu.umich.batchmatch.gui.panels.StickySettingsPanel;
import edu.umich.batchmatch.io.sheetreaders.BinnerInputDataHandler;
...
import edu.umich.batchmatch.process.BatchMatchMatchGroupFilteringEngine;
...
public class BatchMatchSummaryTabPanel extends StickySettingsPanel {
			...
			public void actionPerformed(ActionEvent ae) {
				if (!allFilesImported()) {
					JOptionPane.showMessageDialog(null, "Please import data files before running     "
							+ PostProccessConstants.LINE_SEPARATOR + "a report.    ");
					return;
				}
	...
	private void runReport() throws Exception {
		...
		String confirmDirMsg = "Are you sure that you want to write your report to "
				...
				+ outputDirectoryPanel.getOutputDirectoryPath() + "?" + PostProccessConstants.LINE_SEPARATOR;
