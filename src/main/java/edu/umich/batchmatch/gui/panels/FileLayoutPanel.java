...
import edu.umich.batchmatch.gui.ChecklistParameters;
import edu.umich.batchmatch.gui.PopupChecklist;
...
public abstract class FileLayoutPanel extends StickySettingsPanel {
	...
	public void setupPanel() {
		...
		inputTypeWrapBorder.setTitleColor(PostProccessConstants.TITLE_COLOR);
