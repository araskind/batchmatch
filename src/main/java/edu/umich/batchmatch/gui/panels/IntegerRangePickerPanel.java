...
public abstract class IntegerRangePickerPanel extends StickySettingsPanel {
	...
	private int selectedMin = 0, selectedMax = 100, selectedStep = 1;
	...
	public IntegerRangePickerPanel(String tagForSettings) {
		super();
	...
	private void setupSpinners() {
		SpinnerModel spinnerModelCoresMin = new SpinnerNumberModel(10, selectedMin, selectedMax, selectedStep);
		SpinnerModel spinnerModelCoresMax = new SpinnerNumberModel(10, selectedMin, selectedMax, selectedStep);
	...
	private void setupParametersPanel() {
		...
		minSelectedLabel.setHorizontalAlignment(JLabel.RIGHT);
		maxSelectedLabel.setHorizontalAlignment(JLabel.RIGHT);
		minSelectedBox = makeStickyTextField("minSelected",
				Integer.toString(PostProccessConstants.DEFAULT_BATCH_LEVEL_REPORTED), true);
		...
		// LayoutItem(maxSelectedLabel, 0.03),
		// new LayoutItem(maxSelectedSpinner, 0.03), new LayoutItem(new JLabel(" "),
		// 0.47)));
