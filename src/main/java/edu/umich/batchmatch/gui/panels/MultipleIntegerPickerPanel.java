...
public abstract class MultipleIntegerPickerPanel extends StickySettingsPanel {
	...
	private JTextField n1SelectedBox, n2SelectedBox, n3SelectedBox, n4SelectedBox, n5SelectedBox, n6SelectedBox;
	private JPanel intSelectorWrapPanel;
	private JSpinner n1SelectedSpinner, n2SelectedSpinner, n3SelectedSpinner, n4SelectedSpinner, n5SelectedSpinner,
			n6SelectedSpinner;

	private int selectedMin = 0, selectedMax = 20000, selectedStep = 1;
	private int defaultSelection = 1;
	private TitledBorder intSelectorWrapBorder;

	private String panelTitle, spinnerLabel1, spinnerLabel2, spinnerLabel3, spinnerLabel4, spinnerLabel5, spinnerLabel6;

	public MultipleIntegerPickerPanel(String tagForSettings) {
		super();
	...
	public void setupPanel(String panelTitle, String spinnerLabel1, String spinnerLabel2, String spinnerLabel3,
			String spinnerLabel4, String spinnerLabel5) {
		setupPanel(panelTitle, spinnerLabel1, spinnerLabel2, spinnerLabel3, spinnerLabel4, spinnerLabel5, "");
	}

	public void setupPanel(String panelTitle, String spinnerLabel1, String spinnerLabel2, String spinnerLabel3,
			String spinnerLabel4) {
		setupPanel(panelTitle, spinnerLabel1, spinnerLabel2, spinnerLabel3, spinnerLabel4, "", "");
	}
	...
	public void setupPanel(String panelTitle, String spinnerLabel1, String spinnerLabel2, String spinnerLabel3,
			String spinnerLabel4, String spinnerLabel5, String spinnerLabel6) {
		...
		this.spinnerLabel5 = spinnerLabel5;
		this.spinnerLabel6 = spinnerLabel6;
	...
	private void setupSpinners() {
		...
		SpinnerModel spinnerModelCores5 = new SpinnerNumberModel(defaultSelection, selectedMin, selectedMax,
				selectedStep);

		n5SelectedSpinner = new JSpinner(spinnerModelCores5);
		n5SelectedSpinner.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				Integer val = (Integer) ((JSpinner) e.getSource()).getValue();
				n5SelectedBox.setText("" + val);
				updateForNewSelection(val);
			}
		});
		n5SelectedSpinner.setVisible(!spinnerLabel5.isEmpty());

		SpinnerModel spinnerModelCores6 = new SpinnerNumberModel(defaultSelection, selectedMin, selectedMax,
				selectedStep);

		n6SelectedSpinner = new JSpinner(spinnerModelCores6);
		n6SelectedSpinner.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				Integer val = (Integer) ((JSpinner) e.getSource()).getValue();
				n6SelectedBox.setText("" + val);
				updateForNewSelection(val);
			}
		});
		n6SelectedSpinner.setVisible(!spinnerLabel6.isEmpty());
	}
	...
	private void initializeSpinnersFromTextBoxes() {
		...
		try {
			Integer nInitialCores = Integer.parseInt(n5SelectedBox.getText());
			if (nInitialCores < selectedMin || nInitialCores > selectedMax)
				throw new Exception("Illegal value");
			n5SelectedSpinner.setValue(nInitialCores);
		} catch (Exception e) {
			n5SelectedSpinner.setValue(1);
		}

		try {
			Integer nInitialCores = Integer.parseInt(n6SelectedBox.getText());
			if (nInitialCores < selectedMin || nInitialCores > selectedMax)
				throw new Exception("Illegal value");
			n6SelectedSpinner.setValue(nInitialCores);
		} catch (Exception e) {
			n6SelectedSpinner.setValue(1);
		}
	}
	...
	private void setupParametersPanel() {
		...
		// anyBorder.setTitleColor(PostProccessConstants.TITLE_COLOR);

		n1SelectedLabel.setHorizontalAlignment(JLabel.RIGHT);
		n1SelectedBox = makeStickyTextField("nSelected1", Integer.toString(PostProccessConstants.DEFAULT_BATCH_LEVEL_REPORTED),
				true);
		...
		n2SelectedBox = makeStickyTextField("nSelected2", Integer.toString(PostProccessConstants.DEFAULT_BATCH_LEVEL_REPORTED),
				true);
		...
		n3SelectedBox = makeStickyTextField("nSelected3", Integer.toString(PostProccessConstants.DEFAULT_BATCH_LEVEL_REPORTED),
				true);
		...
		n4SelectedBox = makeStickyTextField("nSelected4", Integer.toString(PostProccessConstants.DEFAULT_BATCH_LEVEL_REPORTED),
				true);
		n4SelectedBox.setVisible(!spinnerLabel4.isEmpty());

		JLabel n5SelectedLabel = new JLabel(this.spinnerLabel5 + " ");
		n5SelectedLabel.setHorizontalAlignment(JLabel.RIGHT);
		n5SelectedBox = makeStickyTextField("nSelected5", Integer.toString(PostProccessConstants.DEFAULT_BATCH_LEVEL_REPORTED),
				true);
		n5SelectedBox.setVisible(!spinnerLabel5.isEmpty());

		JLabel n6SelectedLabel = new JLabel(this.spinnerLabel6 + " ");
		n6SelectedLabel.setHorizontalAlignment(JLabel.RIGHT);
		n6SelectedBox = makeStickyTextField("nSelected6", Integer.toString(PostProccessConstants.DEFAULT_BATCH_LEVEL_REPORTED),
				true);
		n6SelectedBox.setVisible(!spinnerLabel6.isEmpty());
		...
		panelGrid.addRow(Arrays.asList(new LayoutItem(new JLabel("   "), 0.41), new LayoutItem(n5SelectedLabel, 0.03),
				new LayoutItem(n5SelectedSpinner, 0.03), new LayoutItem(new JLabel("   "), 0.06),
				new LayoutItem(n6SelectedLabel, 0.03), new LayoutItem(n6SelectedSpinner, 0.03),
				new LayoutItem(new JLabel("   "), 0.41)));
		...
		intSelectorPanel.add(n5SelectedBox);
		n5SelectedBox.setVisible(false);

		intSelectorPanel.add(n6SelectedBox);
		n6SelectedBox.setVisible(false);
		...
		intSelectorWrapBorder.setTitleColor(PostProccessConstants.TITLE_COLOR);
	...
	public void setInt1Selected(Integer val) {
		...
		n1SelectedSpinner.setValue(val);
	}

	public void setInt2Selected(Integer val) {
		n2SelectedBox.setText(val.toString());
		n2SelectedSpinner.setValue(val);
	}

	public void setInt3Selected(Integer val) {
		n3SelectedBox.setText(val.toString());
		n3SelectedSpinner.setValue(val);
	}

	public void setInt4Selected(Integer val) {
		n4SelectedBox.setText(val.toString());
		n4SelectedSpinner.setValue(val);
	}

	public void setInt5Selected(Integer val) {
		n5SelectedBox.setText(val.toString());
		n5SelectedSpinner.setValue(val);
	}

	public void setInt6Selected(Integer val) {
		n6SelectedBox.setText(val.toString());
		n6SelectedSpinner.setValue(val);
	}
	...
	public Integer getInt1Selected() {
		...
		try {
			...
			intSelected = PostProccessConstants.DEFAULT_BATCH_LEVEL_REPORTED;
		}
		return intSelected;
	}
	...
	public Integer getInt5Selected() {
		Integer intSelected = defaultSelection;
		try {
			intSelected = Integer.parseInt(this.n5SelectedBox.getText());
		} catch (Exception e) {
			intSelected = PostProccessConstants.DEFAULT_BATCH_LEVEL_REPORTED;
		}
		return intSelected;
	...
	public Integer getInt6Selected() {
		Integer intSelected = defaultSelection;
		try {
			intSelected = Integer.parseInt(this.n6SelectedBox.getText());
		} catch (Exception e) {
			intSelected = PostProccessConstants.DEFAULT_BATCH_LEVEL_REPORTED;
		}
		return intSelected;
