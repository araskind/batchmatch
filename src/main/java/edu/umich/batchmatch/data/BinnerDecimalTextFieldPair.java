...
import edu.umich.batchmatch.gui.NumberWithRangeVerifier;
...
public class BinnerDecimalTextFieldPair {
	...
	public BinnerDecimalTextFieldPair(Double lowerLimit, Double lowerDefault, Double upperDefault, Double upperLimit) {
