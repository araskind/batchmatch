...
/*
 * private String namedFeature, unnamedFeature; private Boolean isPrincipalIon;
 * private String annotation; private Double corr; public FeatureMatch() {
 * 
 * } public String getNamedFeature() { return namedFeature; } public void
 * setNamedFeature(String namedFeature) { this.namedFeature = namedFeature; }
 * public String getUnnamedFeature() { return unnamedFeature; } public void
 * setUnnamedFeature(String unnamedFeature) { this.unnamedFeature =
 * unnamedFeature; } public Boolean getIsPrincipalIon() { return isPrincipalIon;
 * } public void setIsPrincipalIon(Boolean isPrincipalIon) { this.isPrincipalIon
 * = isPrincipalIon; } public Double getCorr() { return corr; } public void
 * setCorr(Double corr) { this.corr = corr; }
 * 
 * 
 * public String getAnnotation() { return annotation; } public void
 * setAnnotation(String annotation) { this.annotation = annotation; }
 * 
 * public String toString() { String corrStr = String.format("%5.3", corr);
 * 
 * StringBuilder sb = new StringBuilder(); sb.append(namedFeature + ", ");
 * sb.append(unnamedFeature + ", "); sb.append(corrStr + ",");
 * sb.append(annotation); //sb.append(isPrincipalIon ? "PI" : "-");
 * 
 * return sb.toString(); } }
 */
