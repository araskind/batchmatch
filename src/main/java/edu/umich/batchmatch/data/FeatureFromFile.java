...
public class FeatureFromFile extends Feature {
	...
	public void clearAddedColValues() {
		this.addedColValues = new ArrayList<String>();
	}

	public void initializeBasics(FeatureFromFile feature) {
	...
	public Boolean isPIWith(String carrier) {
	...
	public String toCSVString2() {
		...
		// if (i == 0)
		// continue;
		// sb.append(addedColValues.get(i) + "\t");
		// }
		return sb.toString();
	}
	...
	public String toString() {
		...
		return "Group " + this.getRedundancyGroup() + "Batch " + this.getBatchIdx() + " Intensity "
				+ this.getMedianIntensity() == null ? "" : this.getMedianIntensity() + " " + (parentStr);// +
																											// ObjectHandler.printObject(this));
																											// //this.getName()
																											// + " " +
																											// this.getMass()
																											// + " " +
