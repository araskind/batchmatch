...
public abstract class MultipleIntegerPickerPanel extends StickySettingsPanel {
	...
	private void setupParametersPanel() {
		...
		n5SelectedBox = makeStickyTextField("nSelected5", Integer.toString(BinnerConstants.DEFAULT_BATCH_LEVEL_REPORTED),
				true);
		...
		n6SelectedBox = makeStickyTextField("nSelected6", Integer.toString(BinnerConstants.DEFAULT_BATCH_LEVEL_REPORTED),
				true);
