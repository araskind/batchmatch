...
import edu.umich.mrc2.batchmatch.data.BatchMatchInputObject;
import edu.umich.mrc2.batchmatch.data.RtPair;
import edu.umich.mrc2.batchmatch.data.comparators.BatchMatchFeatureInfoComparator;
import edu.umich.mrc2.batchmatch.data.comparators.SortDirection;
import edu.umich.mrc2.batchmatch.data.comparators.SortProperty;
import edu.umich.mrc2.batchmatch.data.enums.BinnerExportFields;
import edu.umich.mrc2.batchmatch.data.enums.RTValueSource;
import edu.umich.mrc2.batchmatch.utils.DelimitedTextParser;
import edu.umich.mrc2.batchmatch.utils.IOUtils;
import edu.umich.mrc2.batchmatch.utils.Range;
...
public class BatchMatchLatticeBuilder {
	...
	private List<RtPair> sortAndRemoveDuplicatePairs(List<RtPair> rtPairsForLattice) {
		...
		List<RtPair>rtPairsForLatticeClean = new ArrayList<RtPair>();
